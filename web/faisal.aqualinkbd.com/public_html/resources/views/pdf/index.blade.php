          ...
          <table class="table-main">
            ...
            @endforeach
              ...
              <tr class="list-item total-row">
                ...
                <td data-label="Grand Total" class="tableitem th">{{ $invoice->discount }}</td>
            </tr>
            <tr class="list-item total-row">
                <th colspan="4" class="tableitem"></th>
            ...
            <tr class="list-item total-row">
                ...
                <td data-label="Grand Total" class="tableitem th">{{ $invoice->invoiceDetails->sum('subtotal')+ $invoice->shipping + $invoice->vat}}</td>
